...
// This class is exported from the RecognizePattern.dll
class RECOGNIZEPATTERN_API CRecognizePattern {
public:
	CRecognizePattern(void);
	// TODO: add your methods here.
};

extern RECOGNIZEPATTERN_API int nRecognizePattern;
